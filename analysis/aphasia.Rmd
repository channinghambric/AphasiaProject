...
fluency_battery_lm = lm(data = lexical_battery_wide, fluency_score ~ PNT_Total_Correct+semantic_output+phon_output+PRT+Synonymy_Triplet_Test+Camels_and_Cactus_Test+Nonword_Repetition_Test+avg_length)
summary(fluency_battery_lm)

#including max probe lengths
fluency_battery_lm_add_probe = lm(data = lexical_battery_wide, fluency_score ~ PNT_Total_Correct+semantic_output+phon_output+PRT+Synonymy_Triplet_Test+Camels_and_Cactus_Test+Nonword_Repetition_Test+avg_length+Maximum_Category_Probe+Maximum_Rhyme_Probe)
summary(fluency_battery_lm_add_probe)

#just max probe lengths as preds
fluency_battery_lm_just_probe = lm(data = lexical_battery_wide, fluency_score ~ Maximum_Category_Probe+Maximum_Rhyme_Probe)
...
lexical_battery_results <- lexical_battery_long  %>% 
  ...
  nest() %>%                                         # Nest data by cue
 mutate(
    model = map(data, ~ lm(value ~ PNT_Total_Correct+semantic_output+phon_output+PRT+Synonymy_Triplet_Test+Camels_and_Cactus_Test+Nonword_Repetition_Test+avg_length+fluency_score, data = .)) # Fit models
  )
#View results
...
lexical_battery_results_add_probe <- lexical_battery_long  %>% 
  ...
  nest() %>%                                         # Nest data by cue
 mutate(
    model = map(data, ~ lm(value ~ PNT_Total_Correct+semantic_output+phon_output+PRT+Synonymy_Triplet_Test+Camels_and_Cactus_Test+Nonword_Repetition_Test+avg_length+Maximum_Category_Probe+Maximum_Rhyme_Probe+fluency_score, data = .)) # Fit models
  )
#View results
...
lexical_battery_results_just_probe <- lexical_battery_long  %>% 
  ...
  nest() %>%                                         # Nest data by cue
 mutate(
    model = map(data, ~ lm(value ~avg_length+Maximum_Category_Probe+Maximum_Rhyme_Probe+fluency_score, data = .)) # Fit models
  )
#View results
