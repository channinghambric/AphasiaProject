...
#Clustering df
clusters_battery<-best_clusters %>%filter(Group=="PWA") %>%left_join(battery,by="Subject")%>%filter(!Subject %in% participant_drop_list$Subject)
